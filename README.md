...
| | Instant Username Search | Find Out If A Username Has Been Taking On A Site | 😍 | 😍 |😍 | Accuracy Is So-So | https://instantusername.com/?q=<USERNAME> |
...
|**ID Number**| HIB Ransomed? | Site to Check for Data Points in Ransomware Dumps | 😍 | 😍 | 😍 | | [https://github.com/sherlock-project/sherlock](https://haveibeenransom.com/) |
## Location 🗺️
| Data Type | Site or Tool | Description | Free | No Account Needed | Search Limit| Cons | Link |
|---|---|---|---|---|---|--|---|
